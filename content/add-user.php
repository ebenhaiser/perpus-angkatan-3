                ...
                <div class="card-body">
                    ...
                    <form class="" action="" method="post">
                        <div class="form-group mb-3">
                            ...
                            <input
                                <?php echo isset($_GET['edit']) ? ($rowEdit['level'] == "Admin") ? 'checked' : '' : '' ?>
                                type="radio" name="level" value="Admin">Admin
                            <br>
                            <input
                                <?php echo isset($_GET['edit']) ? ($rowEdit['level'] == "Member") ? 'checked' : '' : '' ?>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input
                                <?php echo isset($_GET['edit']) ? ($rowEdit['gender'] == "Male") ? 'checked' : '' : '' ?>
                                type="radio" name="gender" value="Male">Male
                            <br>
                            <input
                                <?php echo isset($_GET['edit']) ? ($rowEdit['gender'] == "Female") ? 'checked' : '' : '' ?>
