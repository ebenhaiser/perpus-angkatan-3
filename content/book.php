<?php
$queryBooks = mysqli_query($connection, "SELECT * FROM books ORDER BY id DESC");
?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $no++ ?></td>
                                <td><?php echo $rowBooks['category'] ?></td>
                                <td><?php echo $rowBooks['shelf_location'] ?></td>
                                ...
                                <td><?php echo $rowBooks['description'] ?></td>
                                <td><?php echo $rowBooks['stock'] ?></td>
                                <td>
